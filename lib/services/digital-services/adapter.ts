...
async function fetchNamecheapCards(ctx: SearchContext): Promise<ServiceCard[]> {
  ...
  return results.map((r): ServiceCard => ({
    ...
    price: r.available ? { amount: 999, currency: 'USD', displayText: 'From $9.99 / yr' } : undefined,
  ...
  return [
    {
      ...
      price: premium ? { amount: 15000, currency: 'USD', displayText: '$150 / hr' } : budget ? { amount: 7500, currency: 'USD', displayText: 'From $75 / project' } : { amount: 7500, currency: 'USD', displayText: '$75 / hr' },
    ...
    },
    {
      ...
      price: premium ? { amount: 17500, currency: 'USD', displayText: '$175 / hr' } : { amount: 9000, currency: 'USD', displayText: '$90 / hr' },
  ...
  return [
    {
      ...
      price: premium ? { amount: 250000, currency: 'USD', displayText: 'From $2,500' } : budget ? { amount: 4999, currency: 'USD', displayText: 'From $49.99' } : { amount: 9000, currency: 'USD', displayText: '$90 / hr' },
  ...
  return [
    {
      ...
      price: premium ? { amount: 30000, currency: 'USD', displayText: '$300 / article' } : budget ? { amount: 2500, currency: 'USD', displayText: '$25 / article' } : { amount: 8000, currency: 'USD', displayText: '$80 / hr' },
  ...
  return [
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=400',
      price: { amount: 999, currency: 'USD', displayText: '$9.99 / yr' },
    ...
    },
    {
      ...
      price: { amount: 699, currency: 'USD', displayText: '$6.99 / yr' },
